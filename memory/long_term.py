...
# 从项目根目录 .env 加载配置（MEM0_CONFIG 定义见 core/config_loader.py）
try:
    from core.config_loader import MEM0_CONFIG
except ImportError:
    MEM0_CONFIG = None
...
class LongTermMemory:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        try:
            ...
            if not mem0_api_key:
                raise ValueError("MEM0_API_KEY not found. Set it in the project root .env file (or as an environment variable).")
            ...
            logger.info("To enable Mem0: set MEM0_API_KEY in the project root .env file (or as an environment variable).")
            self.enabled = False
    ...
    def add_session_summary(
        ...
        try:
            ...
            result = self.mem0.add(
                ...
                user_id="psyx_user",  # 固定用户ID（可扩展为多用户）
                metadata={
